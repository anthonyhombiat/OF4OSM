...
public class OSMMediaWikiAPIClient {
	
	private static final Logger LOGGER = Logger.getLogger(OSMMediaWikiAPIClient.class.getName());
	...
	public OSMMediaWikiAPIClient(){}
	
	public MediaWikiAPIResponse send(MediaWikiAPIRequest req) {
		...
		try {
			...
			return objectMapper.readValue(osmWikiURL, MediaWikiAPIResponse.class);
